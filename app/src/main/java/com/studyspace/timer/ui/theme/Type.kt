...
// Uses the system default font family for now to keep Stage 1 dependency-free.
// A custom display font can be dropped in later without touching call sites.
val StudySpaceTypography = Typography(
